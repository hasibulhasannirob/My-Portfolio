      ...
      <div className=" container m-auto  mt-16">
        ...
        <div className="flex md:flex-col ">
          <div className="left flex-1 w-full">
            ...
            >
              <div className=" flex flex-col gap-6  w-3/4  my-5 md:w-[90%] mx-40">
                <ProgressBar logo={<IoLogoHtml5 />} name={"HTML"} />
                <ProgressBar logo={<IoLogoCss3/>} name={"CSS"} />
              ...
              <div className=" flex flex-col gap-6  w-3/4  my-5 md:w-[90%]">
                ...
                <ProgressBar logo={<FaPython/>} name={"Python"} />
                <ProgressBar logo={<FiFigma/>} name={"Figma"} value={80} />
              </div>
            </div>
          </div>
          {/* right box */}
